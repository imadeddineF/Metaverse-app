  ...
  <section className={`${styles.paddings} relative z-10 `}>
    ...
    >
      ...
      >
        ...
        <div className="absolute top-10 left-[62%] w-[200px] h-[160px] p-[9px] rounded-[25px] bg-[#5d6680] md:block hidden">
          <img
            src="mapCard1.png"
            alt="people"
        ...
        <div className="absolute top-[40%] left-[20%] w-[200px] h-[160px] p-[9px] rounded-[25px] bg-[#5d6680] md:block hidden">
          <img
            src="mapCard2.png"
            alt="people"
            className="relative w-full h-full"
